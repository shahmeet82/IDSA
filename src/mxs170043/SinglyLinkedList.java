...
public class SinglyLinkedList<T> implements Iterable<T> {
    ...
    public void unzip() {
        ...
        Entry<T> tail0 = head.next;  //tail of chain of even indexes
        Entry<T> head1 = tail0.next; //first element at odd index in original list
        Entry<T> tail1 = head1;   //tail of chain of odd indexes/
